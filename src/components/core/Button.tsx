...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-primary text-white hover:bg-dark shadow-primary active:shadow-sm",
  secondary: "bg-secondary text-white hover:bg-dark",
  "outline-primary":
    "border-primary text-primary hover:bg-primary hover:text-white",
  "outline-secondary":
    "border-secondary text-secondary hover:bg-secondary hover:text-white",
  dark: "bg-dark text-white hover:bg-dark/80 hover:text-white shadow-primary-dark active:shadow-sm",
